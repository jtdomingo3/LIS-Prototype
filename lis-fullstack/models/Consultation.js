...
class Consultation {
  constructor(data = {}) {
    ...
    const weight = rawVitals.weight !== undefined && rawVitals.weight !== '' ? rawVitals.weight : (rawVitals.weightKg !== undefined && rawVitals.weightKg !== '' ? rawVitals.weightKg : (data.weight !== undefined && data.weight !== '' ? data.weight : (data.weightKg || '')));
    const height = rawVitals.height !== undefined && rawVitals.height !== '' ? rawVitals.height : (rawVitals.heightCm !== undefined && rawVitals.heightCm !== '' ? rawVitals.heightCm : (data.height !== undefined && data.height !== '' ? data.height : (data.heightCm || '')));
